...
public class FlyingFollowAI extends FlyingAI{
    ...
    public void updateMovement(){
        ...
        if(timer.get(timerTarget3, 30f)){
            following = Units.closest(unit.team, unit.x, unit.y, Math.max(unit.range(), 400f), u -> !u.dead() && !(u.controller() instanceof FlyingFollowAI) && u.type != unit.type, (u, tx, ty) -> -u.maxHealth + Mathf.dst2(u.x, u.y, tx, ty) / 6400f);
        }
    }
